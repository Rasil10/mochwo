...
public class AboutUsImplementor implements AboutUsPresenter {
    ...
    public void setScientificCommiteeMembers() {
        ...
        scientificCommiteeMembers.add(new MemberModel("Dr. Shalik Ram Sigdel", "Institute of Tibetan Plateau Research, Chinese Academy of Sciences", "https://conference2019.kias.org.np/wp-content/uploads/2019/05/Shalik_F.jpg"));
        scientificCommiteeMembers.add(new MemberModel("Dr. Atta-ur-Rahman", "Associate Professor", "https://conference2019.kias.org.np/wp-content/uploads/2019/05/Atta-Ur-Rahman.jpg"));
        ...
        scientificCommiteeMembers.add(new MemberModel("Dr. Ranit Chatterjee", "JST Postdoctoral Fellow Graduate School of Informatics", "https://conference2019.kias.org.np/wp-content/uploads/2019/05/Ranjit.jpg"));
